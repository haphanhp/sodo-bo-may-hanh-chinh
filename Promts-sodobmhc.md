...
Chỉ đào sâu **cấp thượng tầng + cấp tỉnh/thành phố trực thuộc trung ương**. Cấp xã/phường/đặc khu **dừng ở mức liệt kê** (Prompt #15–#19 đã đủ). **Prompt #20–#24 GIỮ NGUYÊN trong file và vẫn hiển thị trong bảng theo dõi, nhưng KHÔNG giao cho acc nào** — phần liệt kê cấp xã đã hoàn tất cho cả nước (34/34 tỉnh, tới An Giang), không đào sâu thêm. Nội dung 5 prompt này để sẵn, dùng lại được nếu sau này mở lại phạm vi. Prompt mới (#25 trở đi) chỉ soạn khi phát hiện thiếu dữ liệu ở cấp thượng tầng hoặc cấp tỉnh.
...
| 20 | Danh sách TÊN ĐẦY ĐỦ từng xã/phường nhóm 1/5 (7 tỉnh: Hà Nội, Cao Bằng, Điện Biên, Hà Tĩnh, Lai Châu, Lạng Sơn, Nghệ An) | Brave | ⏸ GIỮ NGUYÊN, KHÔNG GIAO — phạm vi chỉ dừng ở mức liệt kê (đã xong toàn quốc 34/34 tỉnh, tới An Giang). Nội dung prompt giữ lại để dùng nếu sau này mở lại phạm vi |
| 21 | Danh sách TÊN ĐẦY ĐỦ từng xã/phường nhóm 2/5 (7 tỉnh: Quảng Ninh, Thanh Hóa, Sơn La, Tuyên Quang, Lào Cai, Thái Nguyên, Phú Thọ) | Opera GX | ⏸ GIỮ NGUYÊN, KHÔNG GIAO — phạm vi chỉ dừng ở mức liệt kê (đã xong toàn quốc 34/34 tỉnh, tới An Giang). Nội dung prompt giữ lại để dùng nếu sau này mở lại phạm vi |
...
| 25 | Xác minh Bí thư Thành ủy TP.HCM + đối chiếu Bí thư Tây Ninh + tra 3 thủ tục hành chính mẫu | ~~Brave~~ → **acc Pro tự làm** (acc Free quá tải) | ✅ Đã ráp — xem `41-thu-tuc-hanh-chinh-va-xac-minh-bi-thu.md` và `data/procedures.json` |
...
#### Prompt #20 ⏸ KHÔNG GIAO (2026-09-18 — phạm vi dừng ở mức liệt kê; giữ nguyên nội dung để tham khảo) — Danh sách TÊN ĐẦY ĐỦ nhóm 1/5 (Hà Nội, Cao Bằng, Điện Biên, Hà Tĩnh, Lai Châu, Lạng Sơn, Nghệ An)
...
#### Prompt #21 ⏸ KHÔNG GIAO (2026-09-18 — phạm vi dừng ở mức liệt kê; giữ nguyên nội dung để tham khảo) — Danh sách TÊN ĐẦY ĐỦ nhóm 2/5 (Quảng Ninh, Thanh Hóa, Sơn La, Tuyên Quang, Lào Cai, Thái Nguyên, Phú Thọ)
...
#### Prompt #22 ⏸ KHÔNG GIAO (2026-09-18 — phạm vi dừng ở mức liệt kê; giữ nguyên nội dung để tham khảo) — Danh sách TÊN ĐẦY ĐỦ nhóm 3/5 (Bắc Ninh, Hưng Yên, Hải Phòng, Ninh Bình, Quảng Trị, Đà Nẵng, Quảng Ngãi)
...
#### Prompt #23 ⏸ KHÔNG GIAO (2026-09-18 — phạm vi dừng ở mức liệt kê; giữ nguyên nội dung để tham khảo) — Danh sách TÊN ĐẦY ĐỦ nhóm 4/5 (Huế, Gia Lai, Khánh Hòa, Lâm Đồng, Đắk Lắk, Thành phố Đồng Nai, Tây Ninh)
...
#### Prompt #24 ⏸ KHÔNG GIAO (2026-09-18 — phạm vi dừng ở mức liệt kê; giữ nguyên nội dung để tham khảo) — Danh sách TÊN ĐẦY ĐỦ nhóm 5/5 (TP.HCM, Cần Thơ, Vĩnh Long, Đồng Tháp, Cà Mau, An Giang)
